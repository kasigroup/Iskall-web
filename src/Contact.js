      ...
      <div className="wrapper-contact">
        <div className="contact-content">
          ...
          <div className="contact-content-text">
            <p>We would love to hear from you! Are you interested in free coffee, exploring how we can support your business, our previous work or do you have a project proposal?</p>
